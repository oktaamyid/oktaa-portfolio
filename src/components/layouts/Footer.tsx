...
export default function Footer() {
     ...
     return (
          <footer className="bg-gradient-to-b from-gray-100 via-gray-200 to-gray-300 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 from-1% backdrop-blur-2xl relative overflow-hidden">
